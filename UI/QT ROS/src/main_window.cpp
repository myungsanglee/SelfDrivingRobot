  ...
  ,qnode(argc,argv)
{
  ...
  QObject::connect(&qnode,SIGNAL(imageSignal_pi(cv::Mat)),this,SLOT(display_pi(cv::Mat)));
        /*********************
        ** Logging
        **********************/
...
void MainWindow::ReadSettings() {
    ...
    QString topic_name = settings.value("topic_name", QString("/image_pub")).toString();
...
void MainWindow::display_pi(cv::Mat image)
{
    cv::Mat rgb;
    QImage img;
